...
void on_enter_but_clicked(){
    ...
    if (strcmp(login, username1)==0 && strcmp(password, username1)==0){
        char *name="OxyMed";
    ...
    }else if (strcmp(login, username2)==0 && strcmp(password, username2)==0) {
        char *name = "OxyMed";
    ...
    else if (strcmp(login, username3)==0 && strcmp(password, username3)==0) {
        char *name = "OxyMed";
